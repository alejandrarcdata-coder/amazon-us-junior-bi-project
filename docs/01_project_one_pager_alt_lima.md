# One-pager ALT Lima — US Top-3 Category GMV & Cancellation Recovery
...
| Fecha brief | 09/14/2026 (validado desde Lima) |
...
## 2. Evidencia de disparo (sintético US-only, terna corregida)
...
Tools & Home Improvement **sale del alcance**: no está en el watchlist 3P de Category Ops US (Hardlines Retail).

## 3. Qué pedimos construir (alcance junior, sin cambio de stack)
...
## 7. Pregunta de kickoff que Lima ya propone cerrada

¿Ratifican Home & Kitchen + Sports & Outdoors + Pet Supplies, y `FIN.MP_US_3P_GMV_WKLY` como única fuente oficial de GMV?
---
*Owner: Camila Quispe Rojas (GSC Lima) · Revisión: Senior BI Lead · Status: ALT LIMA — pendiente ratificación kickoff ET*
