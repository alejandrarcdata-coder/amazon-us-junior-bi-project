# RACI ALT Lima — AMP-US-OPS-WKLY-2026Q3
...
Mei Chen (Tools) **sale del RACI de este proyecto**.
...
Nota Lima: tickets de acceso se abren en horario Lima AM para que Marcus (ET) los vea al arrancar su día.
---
*Owner: Camila Quispe Rojas · Revisión: Senior BI Lead · Status: ALT LIMA*
